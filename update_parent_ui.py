...
class _ParentDashboardScreenState extends State<ParentDashboardScreen> {
  ...
  Map<String, dynamic>? _enrolledClassData;
  ...
  Future<void> _enrollStudent() async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        throw Exception("Invalid Class Code or Student Info");
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget _buildNavItem(IconData icon, String label, VoidCallback onTap, {bool danger = false}) {
    return Padding(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                Icon(icon, color: danger ? accentTheme : Colors.white, size: 19),
        ...
        children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.family_restroom, color: Colors.black, size: 36),
                  ),
                  ...
                  ElevatedButton(
                    ...
                    child: const Text("JOIN", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w900)),
                  ),
                ],
              ),
            ),
          ...
          Expanded(
            child: _isLoading
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.search_rounded, size: 50, color: Colors.grey[800]),
                          ),
                ...
                : Container(
                    margin: const EdgeInsets.only(bottom: 12, right: 6, left: 6, top: 2),
                    decoration: BoxDecoration(
                      color: Colors.white,
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        borderRadius: BorderRadius.circular(18),
                        onTap: () {
                          int sId = _enrolledClassData!['student_id'] ?? 0;
                          String sName = _enrolledClassData!['student_name'] ?? _studentNameController.text.trim();
                          if (sName.isEmpty) sName = 'Student';
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      _enrolledClassData!['class_name'] ?? 'Class',
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        "Code: ${_enrolledClassData!['class_code']}",
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: IconButton(
                      icon: const Icon(Icons.exit_to_app_rounded, color: Colors.black, size: 20),
                      onPressed: _doLogout,
                    ),
                  ),
                ],
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: const Icon(Icons.family_restroom, color: maroonTheme, size: 36),
                  ),
                  const SizedBox(height: 16),
                  const Text(
                    "PARENT PORTAL",
                    style: TextStyle(color: accentTheme, fontWeight: FontWeight.w900, letterSpacing: 2, fontSize: 14),
                  ),
                  const SizedBox(height: 40),
                  const Padding(
                  ...
                  _buildNavItem(Icons.add_link_rounded, "Join Class", _showEnrollDialog),
                  const Spacer(),
                  const Padding(
                    padding: EdgeInsets.symmetric(horizontal: 24),
                    child: Divider(color: Colors.white24, thickness: 1.2),
                  ),
                  _buildNavItem(Icons.logout_rounded, "Log Out", _doLogout, danger: true),
...
open('lib/screens/parent_dashboard_screen.dart', 'w', encoding='utf-8').write(new_content)
