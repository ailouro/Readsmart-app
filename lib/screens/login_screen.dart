      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            backgroundColor: const Color.fromARGB(255, 141, 25, 4),
            behavior: SnackBarBehavior.floating,
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(30),
            ),
      ...
      children: [
        ...
        switch (_loginRole) {
          'student' => Container(
            ...
            child: const Text(
              "Student accounts are assigned by the School Administrator. Please ask your Teacher for your LRN login credentials.",
              textAlign: TextAlign.center,
              style: TextStyle(
                color: Colors.black87,
                fontSize: 12,
          ...
          'parent' => Container(
            ...
            child: const Text(
              "Parent accounts are generated by the School Administrator. Please contact the school to obtain your login details.",
              textAlign: TextAlign.center,
              style: TextStyle(
                color: Colors.black87,
                fontSize: 12,
